    ...
    expect(
      mdToSlack(
        [
          ...
          ``,
          `### JIRA issues:`,
          `- [[SE-2449]](link here 0) issue key SE-2449 (@name-SE-2449)`,
          `- [[SE-2441]](link here 1) issue key SE-2441 (@name-SE-2441)`,
          `- [[SE-2440]](link here 2) issue key SE-2440 (@name-SE-2440)`,
          ``,
          `### Others:`,
          `- Add test-screenshot`,
          `- [CONFIG] [master] Use Bitbucket pipeline`,
      ...
      [
        ...
        ``,
        `*JIRA issues:*`,
        `- <link here 0|SE-2449> issue key SE-2449 (<@name-SE-2449>)`,
        `- <link here 1|SE-2441> issue key SE-2441 (<@name-SE-2441>)`,
        `- <link here 2|SE-2440> issue key SE-2440 (<@name-SE-2440>)`,
        ``,
        `*Others:*`,
        `- Add test-screenshot`,
        `- [CONFIG] [master] Use Bitbucket pipeline`,
